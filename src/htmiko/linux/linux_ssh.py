...
from htmiko.cisco_base_connection import CiscoFileTransfer
from htmiko.cisco_base_connection import CiscoSSHConnection
from htmiko.exceptions import ReadTimeout

LINUX_PROMPT_PRI = os.getenv("HTMIKO_LINUX_PROMPT_PRI", "$")
LINUX_PROMPT_ALT = os.getenv("HTMIKO_LINUX_PROMPT_ALT", "#")
LINUX_PROMPT_ROOT = os.getenv("HTMIKO_LINUX_PROMPT_ROOT", "#")
...
HTMiko failed to elevate privileges.
