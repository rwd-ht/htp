...
from htmiko.encryption_handling import ENCRYPTION_PREFIX
from htmiko.encryption_handling import decrypt_value
...
def test_get_encryption_key_missing():
    ...
    if "HTMIKO_TOOLS_KEY" in os.environ:
        del os.environ["HTMIKO_TOOLS_KEY"]
