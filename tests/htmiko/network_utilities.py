...
def generate_acl(
    acl_name="htmiko_test_large_acl",
    entries=100,
...
if __name__ == "__main__":
    ...
    ios_ref_acl = [
        "ip access-list extended htmiko_test_large_acl",
    ...
    nxos_ref_acl = [
        "ip access-list htmiko_test_large_acl",
        "permit ip host 192.168.0.1 any",
        "permit ip host 192.168.0.2 any",
        "permit ip host 192.168.0.3 any",
        "permit ip host 192.168.0.4 any",
    ...
    xr_ref_acl = [
        "ipv4 access-list htmiko_test_large_acl",
    ...
    ref_acl = [
        "set firewall family inet filter htmiko_test_large_acl term 10 from address 192.168.0.1",
        "set firewall family inet filter htmiko_test_large_acl term 10 from address 192.168.0.2",
        "set firewall family inet filter htmiko_test_large_acl term 10 from address 192.168.0.3",
        "set firewall family inet filter htmiko_test_large_acl term 10 from address 192.168.0.4",
        "set firewall family inet filter htmiko_test_large_acl term 10 from address 192.168.0.5",
        "set firewall family inet filter htmiko_test_large_acl term 10 from address 192.168.0.6",
        "set firewall family inet filter htmiko_test_large_acl term 10 from address 192.168.0.7",
        "set firewall family inet filter htmiko_test_large_acl term 10 from address 192.168.0.8",
        "set firewall family inet filter htmiko_test_large_acl term 10 from address 192.168.0.9",
        "set firewall family inet filter htmiko_test_large_acl term 10 from address 192.168.0.10",
    ]
    assert acl == ref_acl

    acl = generate_cisco_asa_acl(entries=10)
    ref_acl = [
        "access-list htmiko_test_large_acl extended permit ip host 192.168.0.1 any",
        "access-list htmiko_test_large_acl extended permit ip host 192.168.0.2 any",
        "access-list htmiko_test_large_acl extended permit ip host 192.168.0.3 any",
        "access-list htmiko_test_large_acl extended permit ip host 192.168.0.4 any",
        "access-list htmiko_test_large_acl extended permit ip host 192.168.0.5 any",
        "access-list htmiko_test_large_acl extended permit ip host 192.168.0.6 any",
        "access-list htmiko_test_large_acl extended permit ip host 192.168.0.7 any",
        "access-list htmiko_test_large_acl extended permit ip host 192.168.0.8 any",
        "access-list htmiko_test_large_acl extended permit ip host 192.168.0.9 any",
        "access-list htmiko_test_large_acl extended permit ip host 192.168.0.10 any",
    ]
    assert acl == ref_acl
